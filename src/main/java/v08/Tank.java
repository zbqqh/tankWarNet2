...
public class Tank {
    ...
    public int x = 100 + random.nextInt(6)*50;
    public int y = 100 + random.nextInt(6)*50;
    ...
    public void setDirection() {
        ...
        if (stop != oldStop || direction != oldDirection){
            NettyClient.INSTANCE.send(new TankStartMovingMsg(this));
    ...
    public void fire() {
        ...
        if (this.life) {
            Missile missile = new Missile(missileX, missileY,true, direction, this.group,UUID.randomUUID(),id);
            NettyClientFrame.INSTANCE.missileList.add(missile);
            MissileMsg msg = new MissileMsg(missile);
            //System.out.println(msg);
            NettyClient.INSTANCE.send(msg);
